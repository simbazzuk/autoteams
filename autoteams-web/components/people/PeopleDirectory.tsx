      ...
      <section className="container people38-body">
        ...
        <section className="people40-network-actions" data-autoteams-people-hero="v7.13.84">
          <div className="people40-network-copy">
            ...
            <div className="people40-network-buttons">
              <Link className="button" href="/members#invite">
                Invite people
              </Link>
              <Link className="button secondary" href="/team-builder">
          ...
          <div className="people40-network-flow">
            <article className="people40-step profile">
              <div className="people40-step-icon">◎</div>
              <span>01</span>
              <h3>Profile</h3>
              <p>Define how you work and contribute.</p>
            </article>

            <div className="people40-connector">→</div>

            <article className="people40-step invite">
              <div className="people40-step-icon">＋</div>
              <span>02</span>
              <h3>Invite</h3>
            ...
            <article className="people40-step people">
              <div className="people40-step-icon">♙</div>
              <span>03</span>
              <h3>Discover</h3>
              <p>Explore strengths across your network.</p>
            </article>

            <div className="people40-connector">→</div>

            <article className="people40-step team">
              <div className="people40-step-icon">✦</div>
              <span>04</span>
              <h3>Build</h3>
              <p>Create the right mix for the outcome.</p>
            </article>
          </div>

          <div className="people40-atlas-note">
            <div className="people40-atlas-mark">✦</div>
            <div>
              <strong>Atlas helps surface the strongest connections.</strong>
              <span>
                Use profile context, strengths and compatibility to move from
                people discovery into team decisions.
              </span>
            </div>
          </div>
        </section>
