...
const opportunities = [
  {
    id: "ai-for-good-hackathon",
    category: "Hackathon",
    icon: "⚡",
    title: "AI for Good Hackathon",
    description: "Join a small cross-functional team to prototype an AI idea with a positive community impact.",
    joined: 3,
    capacity: 5,
    location: "Leeds · Hybrid",
    tags: ["AI / Data", "Product", "Design"],
    tone: "hackathon",
    badge: "2 places",
    avatars: ["A", "J", "P"],
  },
  {
    id: "community-support-project",
    category: "Community",
    icon: "♥",
    title: "Community Support Project",
    description: "Help organise a local initiative bringing together volunteers, planning and outreach.",
    joined: 6,
    capacity: 8,
    location: "Leeds · Local",
    tags: ["Community", "Planning", "Outreach"],
    tone: "community",
    badge: "2 places",
    avatars: ["M", "S", "D", "R"],
  },
  {
    id: "weekend-football-squad",
    category: "Sports",
    icon: "◎",
    title: "Weekend Football Squad",
    description: "A friendly local squad looking for people who enjoy playing, teamwork and meeting new people.",
    joined: 8,
    capacity: 11,
    location: "Leeds · In person",
    tags: ["Football", "Teamwork", "Social"],
    tone: "sports",
    badge: "3 places",
    avatars: ["T", "K", "A", "L"],
  },
      ...
      <div className="container">
        <div className="home-open-teams-v715714__intro">
          <div>
            ...
            <p>Discover something that interests you, see what strengths a team needs and create your AutoTeams profile to get involved.</p>
          </div>
          ...
          {opportunities.map((team) => {
            ...
            return (
              <article className={`home-open-team-card-v715714 home-open-team-card-v715714--${team.tone}`} key={team.id}>
                ...
                <div className="home-open-team-card-v715714__avatars" aria-label={`${team.joined} of ${team.capacity} places filled`}>
                  <div>
                    {team.avatars.map((avatar, index) => (
                      <span aria-hidden="true" key={`${team.id}-${avatar}-${index}`}>{avatar}</span>
                    ))}
                    {team.joined > team.avatars.length && <span aria-hidden="true">+{team.joined - team.avatars.length}</span>}
                  </div>
                ...
                <div className="home-open-team-card-v715714__tags">
        ...
        <div className="home-open-teams-v715714__note">
          ...
          <p><strong>Early-access preview.</strong> These cards demonstrate how public team discovery will work. Live opportunities can replace these examples as teams opt in to public recruitment.</p>
        </div>
      </div>
    </section>
  );
