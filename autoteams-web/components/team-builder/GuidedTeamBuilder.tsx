    ...
    >
      ...
      >
        ...
        >
          <div>
            ...
            <h2>
              Choose who TeamScience.ai can consider.
            </h2>
            <p>
              Select the people
      ...
      >
        ...
        >
          ...
          <h3>
            {workspace?.type === "education"
              ? "Load an Education demo group"
              : "Need people for testing?"}
          </h3>
          <p>
            {workspace?.type === "education"
              ? "Add 12 realistic students across different subjects and strengths, ready for Team Builder testing."
              : "Add five relevant demo people and continue immediately."}
          </p>
          <button
            className="button secondary"
            onClick={onAddDemo}
        ...
        <div className="mvp7150-atlas-explanation-head">
          ...
          <button
            ...
            onClick={async () => {
              ...
              const summary = [
                `TeamScience.ai team summary: ${requirement.name}`,
                "",
                ...
                risks,
                "",
                "TeamScience.ai provides a recommendation. A person makes the final decision.",
              ].join("\n");
...
function AiTelemetryBanner({
  ...
  const statusText = live
    ...
    : developmentMode
      ? "Gemini calls are disabled. TeamScience.ai is using the deterministic recommendation engine to control development costs."
      : "Gemini could not complete the request, so TeamScience.ai used the deterministic recommendation engine.";
