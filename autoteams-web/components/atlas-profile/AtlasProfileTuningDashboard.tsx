      ...
      <div className={styles.layout}>
        ...
        <aside className={styles.sideColumn}>
          ...
          <section className={styles.quickActions}>
            <div className={styles.quickActionsHeading}>
              <div>
                <span className="eyebrow">Profile controls</span>
                <h2>Quick Actions</h2>
              </div>
              <small>Keep your Atlas signals current</small>
            </div>

            <button
              className={`${styles.quickActionRow} ${styles.quickPurple}`}
              onClick={() =>
                openForProfile("/atlas")
              }
              type="button"
            >
              <span className={styles.quickActionIcon}>A</span>
              <div>
                <strong>
            ...
            <button
              className={`${styles.quickActionRow} ${styles.quickAmber}`}
              onClick={() =>
                openForProfile(
                  "/onboarding/profile",
                )
            ...
            <button
              className={`${styles.quickActionRow} ${styles.quickBlue}`}
              onClick={() =>
                openForProfile("/atlas")
              }
              type="button"
            ...
            <Link
              className={`${styles.quickActionRow} ${styles.quickTeal}`}
              href="/my-atlas-profile"
            >
              <span className={styles.quickActionIcon}>H</span>
              <div>
                <strong>
