...
{slug:"team-science-foundations",icon:"TS",title:"Team Science Foundations",summary:"Understand effective teams, complementary strengths and human-centred team decisions.",level:"Beginner",minutes:45,available:true,pathway:"Foundation",modules:[
...
{slug:"building-better-teams",icon:"BT",title:"Building Better Teams",summary:"Apply Team Science to purpose, skills, roles and practical team formation.",level:"Intermediate",minutes:60,available:true,pathway:"Apply",modules:[
...
{slug:"atlas-explainable-ai",icon:"AI",title:"Atlas & Explainable AI",summary:"Interpret AI-supported recommendations, confidence, evidence and human review.",level:"Intermediate",minutes:55,available:true,pathway:"Explain",modules:[
...
{slug:"team-health",icon:"TH",title:"Team Health",summary:"Explore psychological safety, communication, resilience and healthy team signals.",level:"Intermediate",minutes:70,available:true,pathway:"Develop",modules:[
...
{slug:"team-dynamics-leadership",icon:"DL",title:"Team Dynamics & Leadership",summary:"Explore team roles, leadership distribution, influence and how dynamics change as teams evolve.",level:"Advanced",minutes:75,available:false,pathway:"Lead",modules:[]},
{slug:"conflict-collaboration",icon:"CC",title:"Conflict & Collaboration",summary:"Understand constructive challenge, healthy disagreement and strong collaboration.",level:"Advanced",minutes:70,available:false,pathway:"Collaborate",modules:[]},
{slug:"ai-assisted-team-design",icon:"AD",title:"AI-Assisted Team Design",summary:"Apply explainable AI, Team Science evidence and human judgement to complex team design decisions.",level:"Advanced",minutes:90,available:false,pathway:"Design",modules:[]}
];
