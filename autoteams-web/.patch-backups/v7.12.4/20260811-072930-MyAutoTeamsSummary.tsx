...
export function MyAutoTeamsSummary({
  ...
  return (
    <section
      ...
      data-autoteams-summary="v7.12.3"
    >
      <header className={styles.header}>
        <div>
          <span>✦ MY AUTOTEAMS</span>
          <h2>Your profiles and teams at a glance.</h2>
          <p>
            Jump straight into the profile or team you want to explore.
          </p>
        </div>
      </header>
        ...
        {teams.length > 0 ? (
          ...
          <div className={styles.empty}>
            ...
            <div>
              ...
              <p>
                Teams you create will appear here for quick access to Team
                Insights.
              </p>
            </div>
          </div>
