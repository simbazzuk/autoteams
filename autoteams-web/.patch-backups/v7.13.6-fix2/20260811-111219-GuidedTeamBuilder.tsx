...
import { loadTeamForAdjustment } from "@/lib/firebase/team-adjustment";
...
useEffect(() => {
  ...
  /*
   * Preserve the narrowed value inside the async callback.
   */
  const adjustmentTeamId: string =
    teamId;
  ...
  async function load() {
    try {
      ...
      /*
       * Move directly to the existing team confirmation/reconfiguration view.
       * The user can adjust the selected members from there.
       */
      setStep(
        "confirm",
      );
      ...
      console.warn(
        "[AutoTeams] Could not load team for adjustment.",
        error,
      );
    }
  }
