...
import { InviteRegistrationExperience } from "@/components/invite/InviteRegistrationExperience";
import { InviteOnboardingExperience } from "@/components/invite/InviteOnboardingExperience";
...
export function PersonaWizard() {
  ...
  return (
    <div className="wizard">
      ...
      {step === 1 && (
        <section>
          <InviteRegistrationExperience />
          <span className="eyebrow">Step 1</span>
          <InviteOnboardingExperience />
