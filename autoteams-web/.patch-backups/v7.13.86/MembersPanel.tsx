      ...
      <section className="access-content">
        <div className="container access-layout">
          <section className="access-main">
            ...
            <section className="access-panel invite44-guide-panel invite85-guide-panel">
              <div className="access-panel-heading">
                <div>
          ...
          <aside className="access-side">
            <section
              className={`access-panel invite44-compose-panel invite85-compose-panel ${styles.invitePanel}`}
              id="invite"
             ...
             data-autoteams-invite-access-v71385="true">
...
<label
            ...
            <section className="access-panel invite44-pending-panel invite85-pending-panel">
              <div className="access-panel-heading">
                <div>
            ...
            <section
              className="access-panel autoteams-permission-v71376 invite85-permission-panel"
